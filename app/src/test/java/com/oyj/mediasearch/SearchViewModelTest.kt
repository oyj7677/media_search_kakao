...
class SearchViewModelTest {
    ...
    fun init() {
        ...
        mediaRemoteSource = MediaRemoteSourceImpl(service)
    ...
    fun `searchImage()_성공_케이스`() {
        runCatching {
            ...
            val response =
                MockResponse()
                    .setBody(File("src/test/java/com/oyj/mediasearch/response/searchImage_노머스_Response.json").readText())
                    .setResponseCode(200)
    ...
    fun `searchVideo_성공_케이스`() {
        runCatching {
            ...
            val response =
                MockResponse()
                    .setBody(File("src/test/java/com/oyj/mediasearch/response/searchVideo_노머스_Response.json").readText())
                    .setResponseCode(200)
            server.enqueue(response)
